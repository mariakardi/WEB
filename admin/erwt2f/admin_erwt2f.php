...
<html>
  ...
  <script src="https://code.jquery.com/ui/1.13.1/jquery-ui.js"></script>
	...
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.3/Chart.css"></link>
		<script src="admin_erwt2f.js"></script>
		...
		<form  id = "search_form" style = "margin:50px">
                ...
                <div class = "row">
                    <div class = "col-lg-3">
                        <div class = "form-group">
                            <label class = "control-label">Ημερομηνία από </label> 
                        </div>
                    </div>
                    <div class = "col-lg-3">
						<div class = "form-group">
                    ...
                    <div class = "col-lg-3">
						<div class = "form-group">
							<label class = "control-label"> εώς </label> 
						</div>
					</div>
                    <div class = "col-lg-3">
						<div class = "form-group">
                ...
                <div class = "row">
                    <div class ="col-lg-9 col-lg-offset-3" >
                        <div class="form-check" style = "display:none" id="visitDiv">
                            ...
                            <label class="form-check-label">Αριθμός επισκέψεων</label>
                        </div>
                    </div>
                ...
                <div class = "row">
                    <div class ="col-lg-9 col-lg-offset-3" >
                            <div class="form-check"style = "display:none" id="casesDiv">
                                ...
                                <label class="form-check-label">Αριθμός επισκέψεων Κρουσμάτων</label>
                            </div>
                    </div>
                </div>
                <div class = "row">
			...
			<div id = "row" style = "margin:50px">
				<div id = "chart_container" style = "text-align: center">	
					<canvas id="chart_search" style="width:400px; height: 300px; display: inline-block"></canvas>
				</div>
			</div>
        </form>
		<?php
